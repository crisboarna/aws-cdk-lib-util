...
describe('LambdaUtilStack', () => {
  ...
  describe('environmentGeneration', () => {
  ...
  describe('dlq', () => {
    it('default without dlq', () => {
      ...
      const stack = new LambdaUtilStack(app, 'LambdaUtilStack', {
        ...
        lambda: {...lambdaConfig, generateDlq: false},
        projectName,
        stackEnv,
      });
    ...
    it('default with dlq explicit', () => {
      ...
      const stack = new LambdaUtilStack(app, 'LambdaUtilStack', {
        ...
        lambda: { ...lambdaConfig, generateDlq: true },
        projectName,
        stackEnv,
      });
